...
# Title Label
title_label = tk.Label(root, text="TO-DO-LIST", font=("Arial", 24), bg="#646E74")
...
clear_button = tk.Button(button_frame, text="Clear Tasks", command=clear_task,  font=("Arial", 12), bg="#607d8b", fg="black")
