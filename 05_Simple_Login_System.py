...
#Title Label
title_label = tk.Label(root,text="Login System",font=("Arial",20),bg="#5eb0a6")
title_label.pack(pady=20)

#Username Input
username_label = tk.Label(root,text="Username:",font=("Arial",12),bg="#5eb0a6")
username_label.pack()
username_entry = tk.Entry(root,font=("Arial",12))
username_entry.pack(pady=5)

#Password Input
password_label = tk.Label(root,text="Password:",font=("Arial",12),bg="#5eb0a6")
password_label.pack()
